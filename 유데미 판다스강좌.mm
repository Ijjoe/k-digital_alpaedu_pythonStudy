...
<node TEXT="유데미 판다스강좌" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_1090958577" CREATED="1409300609620" MODIFIED="1712586434919"><hook NAME="MapStyle" background="#2e3440">
...
<font BOLD="true"/>
<node TEXT="코드 환경설정 부분" POSITION="bottom_or_right" ID="ID_1982201805" CREATED="1712586436766" MODIFIED="1712586442605">
<node TEXT="pd.options.display.min_rows" ID="ID_875914072" CREATED="1712586444003" MODIFIED="1712586451863"/>
</node>
<node TEXT="버전변경으로인한 에러" POSITION="top_or_left" ID="ID_1508054486" CREATED="1712587175166" MODIFIED="1712587185337">
<node TEXT="titanic.mean().sort_values()" ID="ID_1237645000" CREATED="1712587890242" MODIFIED="1712587892149"/>
<node TEXT="titanic.mean()" ID="ID_50506312" CREATED="1712587893386" MODIFIED="1712587897857"/>
</node>
<node TEXT="코드 함수" POSITION="bottom_or_right" ID="ID_587454050" CREATED="1712587225902" MODIFIED="1712587235706">
<node TEXT="문자만보기(object )" ID="ID_748918656" CREATED="1712587241998" MODIFIED="1712587294872">
<node TEXT="titanic.describe(include=&quot;O&quot;)" POSITION="bottom_or_right" ID="ID_1186091188" CREATED="1712587237479" MODIFIED="1712587241022"/>
</node>
</node>
</node>
</map>
